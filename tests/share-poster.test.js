...
test('stock detail chart does not get stuck on an English loading placeholder', () => {
  ...
  assert.match(longbridge, /quoteContext\.candlesticks/);
  assert.match(longbridge, /Longbridge candlesticks/);
  assert.match(longbridge, /Yahoo K 线不可用，当前使用长桥真实 K 线兜底/);
